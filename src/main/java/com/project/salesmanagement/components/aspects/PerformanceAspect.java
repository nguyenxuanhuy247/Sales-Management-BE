package com.project.salesmanagement.components.aspects;
...
public class PerformanceAspect {
    ...
    //@Pointcut("within(com.project.salesmanagement.controllers.*)")
    //@Pointcut("within(com.project.salesmanagement.controllers.CategoryController)")
